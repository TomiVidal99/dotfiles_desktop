...
configs[server_name] = {
    default_config = {
        ...
        root_dir = "/home/tomii/programming/cpp/mLangLSP/bin"
    },
}

--local root_dir = server.get_server_root_path(server_name)
local root_dir = "/home/tomii/programming/cpp/mLangLSP/bin"
...
local my_server = server.Server:new {
    ...
    default_options = {
        cmd = { path.concat { root_dir, "mlang" }, "--langserver" },
    },
}
